...
fun BvPlayer(
    ...
    playerDoubleBackToExit: Boolean = true,
...
//    }
    ...
    CompositionLocalProvider(
        ...
        VideoPlayerController(
            ...
            doubleBackToExit = playerDoubleBackToExit,
            showRelatedVideos = videoPlayerConfigData.showRelatedVideos,
            onToggleRelatedVideos = onToggleRelatedVideos,
            showRelatedRooms = videoPlayerConfigData.showRelatedRooms,
            onToggleRelatedRooms = onToggleRelatedRooms,
            onSwitchNextRoom = onSwitchNextRoom,
